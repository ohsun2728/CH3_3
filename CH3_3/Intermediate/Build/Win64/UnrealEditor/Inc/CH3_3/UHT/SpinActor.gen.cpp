...
#include "CH3_3/Public/SpinActor.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeSpinActor() {}

// Begin Cross Module References
CH3_3_API UClass* Z_Construct_UClass_ASpinActor();
CH3_3_API UClass* Z_Construct_UClass_ASpinActor_NoRegister();
...
// Begin Class ASpinActor
void ASpinActor::StaticRegisterNativesASpinActor()
{
}
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(ASpinActor);
UClass* Z_Construct_UClass_ASpinActor_NoRegister()
{
	return ASpinActor::StaticClass();
}
struct Z_Construct_UClass_ASpinActor_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
		{ "IncludePath", "SpinActor.h" },
		{ "ModuleRelativePath", "Public/SpinActor.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_SceneRoot_MetaData[] = {
		{ "Category", "SpinActor|Components" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/SpinActor.h" },
	};
	...
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
		TCppClassTypeTraits<ASpinActor>::IsAbstract,
	};
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASpinActor_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASpinActor_Statics::NewProp_RotationSpeed,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ASpinActor_Statics::PropPointers) < 2048);
UObject* (*const Z_Construct_UClass_ASpinActor_Statics::DependentSingletons[])() = {
	(UObject* (*)())Z_Construct_UClass_AActor,
	(UObject* (*)())Z_Construct_UPackage__Script_CH3_3,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_ASpinActor_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_ASpinActor_Statics::ClassParams = {
	&ASpinActor::StaticClass,
	"Engine",
	&StaticCppClassTypeInfo,
	DependentSingletons,
	nullptr,
	Z_Construct_UClass_ASpinActor_Statics::PropPointers,
	nullptr,
	UE_ARRAY_COUNT(DependentSingletons),
	0,
	UE_ARRAY_COUNT(Z_Construct_UClass_ASpinActor_Statics::PropPointers),
	0,
	0x009000A4u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ASpinActor_Statics::Class_MetaDataParams), Z_Construct_UClass_ASpinActor_Statics::Class_MetaDataParams)
};
UClass* Z_Construct_UClass_ASpinActor()
{
	if (!Z_Registration_Info_UClass_ASpinActor.OuterSingleton)
	{
		UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_ASpinActor.OuterSingleton, Z_Construct_UClass_ASpinActor_Statics::ClassParams);
	}
	return Z_Registration_Info_UClass_ASpinActor.OuterSingleton;
}
template<> CH3_3_API UClass* StaticClass<ASpinActor>()
{
	return ASpinActor::StaticClass();
}
DEFINE_VTABLE_PTR_HELPER_CTOR(ASpinActor);
ASpinActor::~ASpinActor() {}
// End Class ASpinActor
